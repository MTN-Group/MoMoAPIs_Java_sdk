...
//TODO comment needed on all variables
...
//    public static final String REST_API_SANDBOX_ENDPOINT_MOMO = "https://sandbox.momodeveloper.mtn.com";
    ...
    //TODO is the TARGET_ENVIRONMENT limited to SANDBOX and PRODUCTION? How to allow other TARGET_ENVIRONMENT values?
    //If it needs to be passed in as a parameter, then it will only be allowed in production environment
    //the value cannot be validated fully, as there is no proper guideline
